...
/**
 * This class defines the screen of delivery man My Account screen
 */
public class DeliveryManMyAccountScreenFXController extends Pane implements Initializable {
     ...
     * Constructor
     */
    public DeliveryManMyAccountScreenFXController(){
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/gui/delivery_man/DeliveryManMyAccountScreenFX.fxml"));
