...
public class CompanyMarketingWorkerMyAccountScreenFXController extends Pane implements Initializable {
     ...
     */
    public CompanyMarketingWorkerMyAccountScreenFXController(){
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/gui/company_marketing_worker/CompanyMarketingWorkerMyAccountScreenFX.fxml"));
