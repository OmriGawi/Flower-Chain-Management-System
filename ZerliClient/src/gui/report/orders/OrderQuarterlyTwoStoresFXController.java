...
/**
 * This class defines the Order quarterly report screen for two reports
 */
public class OrderQuarterlyTwoStoresFXController extends Pane implements Initializable {
    ...
    // Variables
    public static OrderReport quarterlyReport1;
    public static OrderReport quarterlyReport2;
     ...
     */
    public OrderQuarterlyTwoStoresFXController(OrderReport report1, OrderReport report2){
        quarterlyReport1 = report1;
        quarterlyReport2 = report2;

        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/gui/report/orders/OrderQuarterlyTwoStoresFX.fxml"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Get Data
        HashMap<String, Integer> dataMap1 = quarterlyReport1.getObject().getKey();
        Item bestSellerItem1 = quarterlyReport1.getObject().getValue();
        ...
        // Get Data
        HashMap<String, Integer> dataMap2 = quarterlyReport2.getObject().getKey();
        Item bestSellerItem2 = quarterlyReport2.getObject().getValue();
        ...
        // Put Item data in gui
        itemNameLabel2.setText(bestSellerItem2.getName());
        itemPriceLabel2.setText(bestSellerItem2.getPriceWithoutDiscount() + " ILS");
