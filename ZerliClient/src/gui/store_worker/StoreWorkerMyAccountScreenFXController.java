...
/**
 * This class defines the Store Worker My Account screen
 */
public class StoreWorkerMyAccountScreenFXController extends Pane implements Initializable {
     ...
     * Constructor
     */
    public StoreWorkerMyAccountScreenFXController(){
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/gui/store_worker/StoreWorkerMyAccountScreenFX.fxml"));
